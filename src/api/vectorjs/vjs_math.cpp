...
namespace VectorJS {
    ...
    static void register_vector2_class(qjspp::Engine& engine, qjspp::ModuleBuilder& builder) {
        ...
        cls.instance_method("add", [](JSVector2* self, const qjspp::ArgList& args) -> qjspp::Value {
        ...
        cls.instance_method("scale", [](JSVector2* self, const qjspp::ArgList& args) -> qjspp::Value {
            if (!self || args.empty()) return {};
            Vector2 res = Vector2Scale(*self, static_cast<float>(args[0].to_double()));
            return qjspp::make_native_object(args[0].context(), std::make_unique<JSVector2>(res));
        });

        cls.instance_method("length", [](JSVector2* self, const qjspp::ArgList& args) -> qjspp::Value {
            if (!self) return {};
            return qjspp::Value::make_double(args[0].context(), Vector2Length(*self));
        });

        cls.instance_method("normalize", [](JSVector2* self, const qjspp::ArgList& args) -> qjspp::Value {
            if (!self) return {};
            Vector2 res = Vector2Normalize(*self);
            return qjspp::make_native_object(args[0].context(), std::make_unique<JSVector2>(res));
        });

        cls.instance_method("subtract", [](JSVector2* self, const qjspp::ArgList& args) -> qjspp::Value {
            auto* other = qjspp::get_native_opaque<JSVector2>(args[0]);
            if (!self || !other) return {};
        ...
        cls.instance_method("multiply", [](JSVector2* self, const qjspp::ArgList& args) -> qjspp::Value {
            auto* other = qjspp::get_native_opaque<JSVector2>(args[0]);
            if (!self || !other) return {};
        ...
        cls.instance_method("dot", [](JSVector2* self, const qjspp::ArgList& args) -> qjspp::Value {
            auto* other = qjspp::get_native_opaque<JSVector2>(args[0]);
            if (!self || !other) return {};
            return qjspp::Value::make_double(args[0].context(), Vector2DotProduct(*self, *other));
        });

        cls.instance_method("distance", [](JSVector2* self, const qjspp::ArgList& args) -> qjspp::Value {
            auto* other = qjspp::get_native_opaque<JSVector2>(args[0]);
            if (!self || !other) return {};
            return qjspp::Value::make_double(args[0].context(), Vector2Distance(*self, *other));
        });

        cls.instance_method("negate", [](JSVector2* self, const qjspp::ArgList& args) -> qjspp::Value {
            if (!self) return {};
            Vector2 res = Vector2Negate(*self);
            return qjspp::make_native_object(args[0].context(), std::make_unique<JSVector2>(res));
        });

        cls.instance_method("lerp", [](JSVector2* self, const qjspp::ArgList& args) -> qjspp::Value {
