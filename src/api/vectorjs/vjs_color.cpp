...
namespace App::Module::VectorJS {
    ...
    void register_color_class(qjspp::Engine& engine, qjspp::ModuleBuilder& builder) {
        ...
        cls.instance_method("contrast", [](JSColor* self, const qjspp::ArgList& args) -> qjspp::Value {
            if (!self || args.empty()) return {};
        ...
        cls.instance_method("alpha", [](JSColor* self, const qjspp::ArgList& args) -> qjspp::Value {
            if (!self || args.empty()) return {};
        ...
        cls.instance_method("tint", [](JSColor* self, const qjspp::ArgList& args) -> qjspp::Value {
            if (!self || args.empty()) return {};
        ...
        cls.static_method("fromHex", [](const qjspp::ArgList& args) -> qjspp::Value {
        ...
        cls.static_method("fromHSV", [](const qjspp::ArgList& args) -> qjspp::Value {
        ...
        cls.instance_method("isEqual", [](JSColor* self, const qjspp::ArgList& args) -> qjspp::Value {
